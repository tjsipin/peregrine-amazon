...
TJ edit: This is done after a failed first attempt with the first v3 Brazil-2000 toy output.
...
rasterOptions(tmpdir = "/Home/tjsipin/Data/RasterTemp", tmptime=1) #temporary raster storage
...
#Read in land cover layers by year: update this with new processed data folder so I don't pull from the raw data folder, as in Sofie's code
