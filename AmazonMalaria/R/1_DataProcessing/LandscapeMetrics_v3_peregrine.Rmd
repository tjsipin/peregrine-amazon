...
lc_2000<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2000_LULC_v3_Pro.tif")
```
...
brazil_muni<-read_sf("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/Municipios/Amazonian_Municipios_Projected/Brazil_Amazonian_Municipios_Projected.shp")
colombia_muni<-read_sf("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/Municipios/Amazonian_Municipios_Projected/MGN_MPIO_POLITICO.shp") %>% 
  dplyr::rename(MPIOS = MPIO_CCNCT)
peru_muni<-read_sf("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/Municipios/Amazonian_Municipios_Projected/Peru_Amazonian_Municipios_Projected.shp")
...
for(i in 1:length(uniq_brazil_muni)){
  ...
  if(length(unique(lcmuni))>1){ #If multiple values, even with background, save raster
    writeRaster(lcmuni, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/PanAmazonia_Municipios/Brazil/lcmuni_2000/", muni, ".tif"), overwrite=TRUE)
...
#Read in names of rasters in folder and subset shapefile and save-for final muni shapefile
  brazil_final_munis<-substring(list.files("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/PanAmazonia_Municipios/Brazil/lcmuni_2000"), 1, 7) %>% 
    as.data.frame(stringsAsFactors=FALSE)
  colnames(brazil_final_munis)<-c("codigo_ibg")
  brazil_muni_final <- right_join(brazil_muni, brazil_final_munis, by="codigo_ibg")
#Write shapefile
  write_sf(brazil_muni_final, "~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/Municipios/Final_Amazonian_Municipios_Projected/Final_Brazil_Amazonian_Municipios_Projected.shp", delete_layer = TRUE)
...
##lc_2000_test <- raster('~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Year_v3/PanAmazonia_2000_LULC_v3.tif') # need projection

colombia_muni<-read_sf("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/Municipios/Amazonian_Municipios_Projected/colombia_dane_2018.shp") %>% 
  dplyr::rename(MPIOS = MPIO_CCNCT) %>% 
  filter(MPIOS %in% c_muni$MPIOS) # need projection to use on lc_2000
...
for(i in 1:length(uniq_colombia_muni)){
  ...
  if(length(unique(lcmuni))>1){ #If multiple values, even with background, save raster
    writeRaster(lcmuni, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/PanAmazonia_Municipios/Colombia/lcmuni_2000/", muni, ".tif"), overwrite=TRUE)
  }else if(length(unique(lcmuni))==1){ #If one value, save if value is not 0 (background)
      if(unique(lcmuni)>0){
          writeRaster(lcmuni, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/PanAmazonia_Municipios/Colombia/lcmuni_2000/", muni, ".tif"), overwrite=TRUE)
      }else if(unique(lcmuni)==0){
...
#Read in names of rasters in folder and subset shapefile and save-for final muni shapefile
  colombia_final_munis<-substring(list.files("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/PanAmazonia_Municipios/Colombia/lcmuni_2000"), 1, 5) %>% 
    as.data.frame(stringsAsFactors=FALSE)
  colnames(colombia_final_munis)<-c("MPIOS")
  colombia_muni_final <- right_join(colombia_muni, colombia_final_munis, by="MPIOS")
#Write shapefile
write_sf(colombia_muni_final, "~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/Municipios/Final_Amazonian_Municipios_Projected/Final_Colombia_Amazonian_Municipios_Projected.shp", delete_layer = TRUE)
...
for(i in 1:length(uniq_peru_muni)){
  ...
  if(length(unique(lcmuni))>1){ #If multiple values, even with background, save raster
    writeRaster(lcmuni, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/PanAmazonia_Municipios/Peru/lcmuni_2000/", muni, ".tif"), overwrite=TRUE)
  }else if(length(unique(lcmuni))==1){ #If one value, save if value is not 0 (background)
      if(unique(lcmuni)>0){
          writeRaster(lcmuni, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/PanAmazonia_Municipios/Peru/lcmuni_2000/", muni, ".tif"), overwrite=TRUE)
      }else if(unique(lcmuni)==0){
...
#Read in names of rasters in folder and subset shapefile and save-for final muni shapefile
  peru_final_munis<-substring(list.files("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/PanAmazonia_Municipios/Peru/lcmuni_2000"), 1, 8) %>% 
    as.data.frame(stringsAsFactors=FALSE)
  colnames(peru_final_munis)<-c("ADM3_PCODE")
  peru_muni_final <- right_join(peru_muni, peru_final_munis, by="ADM3_PCODE")
#Write shapefile
write_sf(peru_muni_final, "~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/Municipios/Final_Amazonian_Municipios_Projected/Final_Peru_Amazonian_Municipios_Projected.shp", delete_layer = TRUE)
...
#Country Shapefiles
brazil_municipios<-read_sf("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/Municipios/Final_Amazonian_Municipios_Projected/Final_Brazil_Amazonian_Municipios_Projected.shp")
colombia_municipios<-read_sf("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/Municipios/Final_Amazonian_Municipios_Projected/Final_Colombia_Amazonian_Municipios_Projected.shp")
peru_municipios<-read_sf("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/Municipios/Final_Amazonian_Municipios_Projected/Final_Peru_Amazonian_Municipios_Projected.shp")

#Land Use Rasters [UPDATED]
# lc_2000<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2000_LULC_v3_Pro.tif")
lc_2001<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2001_LULC_v3_Pro.tif")
# lc_2002<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2002_LULC_v3_Pro.tif")
# lc_2003<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2003_LULC_v3_Pro.tif")
# lc_2004<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2004_LULC_v3_Pro.tif")
# lc_2005<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2005_LULC_v3_Pro.tif")
# lc_2006<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2006_LULC_v3_Pro.tif")
# lc_2007<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2007_LULC_v3_Pro.tif")
# lc_2008<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2008_LULC_v3_Pro.tif")
# lc_2009<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2009_LULC_v3_Pro.tif")
# lc_2010<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2010_LULC_v3_Pro.tif")
# lc_2011<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2011_LULC_v3_Pro.tif")
# lc_2012<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2012_LULC_v3_Pro.tif")
# lc_2013<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2013_LULC_v3_Pro.tif")
# lc_2014<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2014_LULC_v3_Pro.tif")
# lc_2015<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2015_LULC_v3_Pro.tif")
# lc_2016<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2016_LULC_v3_Pro.tif")
# lc_2017<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2017_LULC_v3_Pro.tif")
# lc_2018<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2018_LULC_v3_Pro.tif")
# lc_2019<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2019_LULC_v3_Pro.tif")
# lc_2020<-raster("~/AmazonMalaria/Data/Raw/PanAmazonia/PanAmazonia_Projected_v3/PanAmazonia_2020_LULC_v3_Pro.tif")
...
```{r}
brazil_lcmuni_2001 <- list.files(path = '~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/PanAmazonia_Municipios/Brazil/lcmuni_2001')
bm <- NA
for(i in 1:length(brazil_lcmuni_2001)){
  bm[i] <- substring(brazil_lcmuni_2001[i], 1, 7)
}

bm <- bm %>% as.numeric()

unique(as.numeric(brazil_municipios$codigo_ibg)) %>% sort()

setdiff(unique(as.numeric(brazil_municipios$codigo_ibg)), bm)
```
...
CropMaskBrazil<-function(year, ras){
  ...
  rasterOptions(tmpdir=file.path("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/RasterTmp")) #sets temp directory
  ...
  registerDoParallel(cores=15)#initiate multiple cores for processing (set to under computer/server limit)
      result<-foreach(c=1:length(munis))%dopar%{
        ...
        writeRaster(lcmuni, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/PanAmazonia_Municipios/Brazil/lcmuni_", year, "/", muni, ".tif"),
                    overwrite=TRUE)
    ...
    #     
    #   }#End Parallel processing
    unlink(file.path("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/RasterTmp"), recursive = TRUE) #removes entire temp directory 
  }#End Brazil Function
...
CropMaskColombia<-function(year, ras){
  ...
  munis<-unique(as.numeric(colombia_municipios$MPIOS))#Municipios to loop through
    ...
    #Temporary raster directory
  dir.create (file.path("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/RasterTmp"), showWarnings = FALSE)  #creates unique filepath for temp directory
  rasterOptions(tmpdir=file.path("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/RasterTmp")) #sets temp directory
  ...
  # registerDoParallel(cores=15)#initiate multiple cores for processing (set to under computer/server limit)
      result<-foreach(c=1:length(munis))%dopar%{
        ...
        #Write Raster (none should be empty or all background from earlier analysis)
        writeRaster(lcmuni, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/PanAmazonia_Municipios/Colombia/lcmuni_", year, "/", muni, ".tif"),
...
CropMaskPeru<-function(year, ras){
  ...
  # registerDoParallel(cores=15)#initiate multiple cores for processing (set to under computer/server limit)
      ...
      #Write Raster (none should be empty or all background from earlier analysis)
      writeRaster(lcmuni, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/PanAmazonia_Municipios/Peru/lcmuni_", year, "/", muni, ".tif"),
                  overwrite=TRUE, progress = c('text', 'window'))
      }
      # result<-for(c in 1:length(munis)) {
      #   muni<-munis[c] #get municipio
...
CalculateLandscapeMetrics<-function(country, year){
  ...
  country<-country
  year<-year
  lc_munis<-list.files(paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/PanAmazonia_Municipios/",
                                       country, "/lcmuni_", year), full.names=TRUE)
  #Temporary raster directory
  dir.create (file.path("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/RasterTmp"), showWarnings = FALSE)#unique filepath for temps
  rasterOptions(tmpdir=file.path("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics_v3/RasterTmp")) #sets temp directory
  ...
  result<-foreach(c=1:length(lc_munis))%dopar%{ 
    ...
    adjdf<-as.data.frame(adj) %>% #Adjacency matrix to dataframe
      ...
      write_csv(classmetrics, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/",
                                     country, "/lcmuni_", year, "/classmetrics/", muni, ".csv"))
      write_csv(adjdf, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/",
...
#Combine municipality csvs for classmetrics and adjacencymatrix
  ...
  for (c in countries){
    ...
    for (y in years){
      ...
      list_of_files <- list.files(path = paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/", country, "/lcmuni_", year, "/", metric),
                                  pattern = ".csv",
                                  full.names = TRUE)
      ...
      #Save csv
      write_csv(df, paste0("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/metric_csv/",metric, "/", country, "_", year, ".csv"))
...
#Combine all classmetric and adjacency cvs across years and countries
  #Clean up both csvs and save (not combine because a lot of information)
    ...
    #Class metrics
      filelist_cm <- list.files(path = "~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/metric_csv/classmetrics",
      ...
      cm_names<-read_csv("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/metric_csv/classmetrics_column_names_v3.csv")
      ...
      write_csv(classmetrics, "~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/metric_csv/classmetrics.csv")

    #Adjacency Matrix
      filelist_adj <- list.files(path = "~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/metric_csv/adjacencymatrix",
                                pattern = ".csv", full.names = TRUE)
      adj <- Reduce(rbind, lapply(filelist_adj, read_csv))#Combine all csvs
      adj_names<-read_csv("~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/metric_csv/adjacencymatrix_column_names_v3.csv")
      ...
      write_csv(adjacencymatrix, "~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/metric_csv/adjacencymatrix.csv")
