...
classmetrics<-readr::read_csv("Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics/PanAmaMuni_allclasses/metric_csv/classmetrics.csv",
                              guess_max = min(100000, Inf)) #Guess more to overcome parsing failures
#Read in adjacencymatrix
adjacencymatrix<-readr::read_csv("Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics/PanAmaMuni_allclasses/metric_csv/adjacencymatrix.csv",
                                 guess_max = min(100000, Inf)) #Guess more to overcome parsing failures
...
#Write csvs
write_csv(classmetrics_df, "Data/1_DataProcessing/LandscapeMetrics/classmetrics_df.csv")
write_csv(adjacency_df, "Data/1_DataProcessing/LandscapeMetrics/adjacency_df.csv")
