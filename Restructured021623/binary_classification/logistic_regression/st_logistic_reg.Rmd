...
percent_wrong.df <- full.incorrect %>% 
  select(Code, Year, Country, correct, 
         land_use_change, forest_density, forest_fragmentation, edge_loss) %>% 
...
mapview::mapview(percent_wrong.all_incorrect.df, zcol = 'mean_edge_loss')
mapview::mapview(percent_wrong.no_correct.df, zcol = 'mean_edge_loss')
