...
```{r data}
old_adj <- read.csv('~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics/PanAmaMuni_allclasses/metric_csv/adjacencymatrix/Brazil_2000.csv')

new_adj <- read.csv('~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/metric_csv/adjacencymatrix/Brazil_2000.csv')
```
...
```{r}
old_class <- read_csv('~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics/PanAmaMuni_allclasses/metric_csv/classmetrics/Brazil_2000.csv') %>% 
  filter(class == 3) %>% 
  dplyr::select(-c(layer, id, level, class))

new_class <- read_csv('~/AmazonMalaria/Data/1_DataProcessing/LandscapeMetrics/LandscapeMetrics_v3/PanAmaMuni_allclasses/metric_csv/classmetrics/Brazil_2000.csv') %>% 
  filter(class == 3) %>% 
  dplyr::select(-c(layer, id, level, class))
```
